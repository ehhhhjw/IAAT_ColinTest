...
public class TreePanel extends JPanel {  
    ...
    private int gridHeight = 140;    //每个结点的高度  
     ...
     * @param n 要绘制的树 
     */  
    public TreePanel(ActivityTreeNode n){  
     ...
     * @param childAlign 对齐策略 
     */  
    public TreePanel(ActivityTreeNode n, int childAlign){  
        super();  
        setTree(n);  
    ...
    public void drawAllNode(ActivityTreeNode n, int x, Graphics g){  
        ...
        //TODO:???
        ImageIcon icon=new ImageIcon("NodeScreenShots " + File.separator + n.getName()+".jpg");
